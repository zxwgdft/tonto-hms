...
public class SpringBeanHolder implements ApplicationContextAware{
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Object getFirstBeanByType(Class<?> type)
	{	
		try{
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Object getFirstBeanByType(Class<?> type, boolean includeNonSingletons,
            boolean allowEagerInit)
	{
		try{
			Map beansMap= appContext.getBeansOfType(type,includeNonSingletons,allowEagerInit);
			return getMapFirstValue(beansMap);
		}
		catch(Exception e)
		{
	...
	@SuppressWarnings("rawtypes")
	private static Object getMapFirstValue(Map map)
	{
